...
description: Produce a PowerPoint deck in the Avalere Health 2025 template, on-brand and cited from the wiki
triggers:
  - query_patterns: ["build a deck", "make a presentation", "avalere deck", "slides for"]
...
- Template (pinned): `../_assets/Avalere_PPT_template.potx` (theme Avalere Health 2025, Inter font family, 132 named layouts).
